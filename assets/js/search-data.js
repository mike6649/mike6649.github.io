    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-chatpcb",
          title: 'ChatPCB',
          description: "AR-powered app for improving PCB fabrication process",
          section: "Projects",handler: () => {
              window.location.href = "/projects/chatpcb/";
            },},{id: "projects-ethereum-network-visualization",
          title: 'Ethereum Network Visualization',
          description: "Visualizing blockchain transaction network as a graph",
          section: "Projects",handler: () => {
              window.location.href = "/projects/eth-visualization/";
            },},{id: "projects-fl-minillm",
          title: 'FL-MiniLLM',
          description: "Federated knowledge distillation of generative LLMs",
          section: "Projects",handler: () => {
              window.location.href = "/projects/fl-minillm/";
            },},{id: "projects-kendeda-eui",
          title: 'Kendeda EUI',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/powermap/";
            },},{
        id: 'social-cv',
        title: 'CV',
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/cv-michaeltang.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%69%63%68%61%65%6C%74%61%6E%67%36%36%34%39@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/mike6649", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/mike6649", "_blank");
        },
      },{
      id: 'light-theme',
